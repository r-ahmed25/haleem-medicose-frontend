...
const GiftCouponCard = () => {
	...
	return (
		<motion.div
			className='space-y-4 rounded-lg border border-gray-700 bg-mute-800 p-4 shadow-sm sm:p-6'
		...
		>
			<div className='space-y-4'>
				<div>
					<label htmlFor='voucher' className='mb-2 block text-sm font-medium text-green-700'>
